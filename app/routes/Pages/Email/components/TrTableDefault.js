    ...
    {props.templates.map((template) => (
      <tr key={template.id}>
        <td className="align-middle">
          <div className={props.projectColor}>{template.name}</div>
        </td>
        <td className="align-middle">
          <span className="text-inverse">{template.subject}</span>
        </td>
        <td className="align-middle">
          <div>{template.send_email.toString()}</div>
        </td>
        <td className="align-middle">
          <div>{DateFormat(template.created_at)}</div>
        </td>
